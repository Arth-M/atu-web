...
export function ThemeSwitch() {
  ...
  return (
    <div className="fixed top-3 left-1/2 transform -translate-x-1/2 rounded-2xl font-secondary z-50 grid grid-cols-3 justify-items-center border border-primary/50 bg-secondary/15 shadow-lg shadow-secondary/40 backdrop-blur-xs">
      {themes.map((t) => {
